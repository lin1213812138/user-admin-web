    ...
    dataManage: {
      ...
      basic: {
        ...
        remote: {
          ...
          remoteCount: 'Remote Records',
          updateBy: 'Updated By',
          updateDate: 'Updated Time',
          destination: 'Destination',
          destinationPlaceholder: 'Select country/region',
          city: 'City',
          zip: 'Zip Code',
          cityOrZipTip: 'City or zip code is required',
          groupPlaceholder: 'Please select',
          addGroup: 'Add Category',
          createTitle: 'Add Remote Category',
          import: 'Import',
          importTitle: 'Import Remote Data',
          importTemplate: 'Remote Data Excel Template',
          chooseFile: 'Choose File',
          exportListData: 'Export List',
          confirmImport: 'Import',
          importOverwriteTip: 'Import will overwrite {count} existing remote records in this category. Continue?',
          ...
          checkPassed: 'Passed',
          skipInvalidTip: 'Skipped {count} row(s) that failed validation',
          editTitle: 'Edit Remote Data',
          remove: 'Remove',
          editUpdated: 'Updated',
          noValidTip: 'No rows passed validation. Please fix the failed rows first',
          templateName: 'remote-import-template',
          exportName: 'remote-data'
        }
      },
      finance: {
        title: 'Finance',
      ...
      ship: {
        ...
        carrier: {
          ...
          feeExtDrawer: {
            ...
            syncConfirm: 'Sync {n} surcharge(s) to {m} channel(s). Continue?',
