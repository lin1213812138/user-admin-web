    ...
    dataManage: {
      ...
      basic: {
        ...
        remote: {
          ...
          updateDate: '数据更新时间',
          destination: '目的地',
          destinationPlaceholder: '请选择国家/地区',
          city: '城市',
          zip: '邮编',
          cityOrZipTip: '城市与邮编至少填写一项',
          groupPlaceholder: '请选择',
          addGroup: '新增类别',
          createTitle: '新增偏远类别',
          import: '导入',
          importTitle: '偏远数据导入',
          importTemplate: '偏远数据导入Excel模板',
          chooseFile: '选择文件',
          exportListData: '导出列表数据',
          confirmImport: '确定导入',
          importOverwriteTip: '导入将覆盖该类别下已存在的 {count} 条偏远数据，是否继续？',
          importSuccess: '导入成功',
          countryCode: '国家代码',
          zipStart: '起始邮编',
          zipEnd: '结束邮编',
          checkResult: '校验结果',
          checkPassed: '通过',
          skipInvalidTip: '已跳过 {count} 条未通过校验的数据',
          editTitle: '编辑偏远数据',
          remove: '移除',
          editUpdated: '已更新',
          noValidTip: '没有校验通过的数据，请先修正未通过的行',
          templateName: '偏远数据导入模板',
          exportName: '偏远数据'
        }
      },
      finance: {
      ...
      ship: {
        ...
        carrier: {
          ...
          feeExtDrawer: {
            ...
            syncConfirm: '将把 {n} 条费用同步到 {m} 个渠道，是否继续？',
