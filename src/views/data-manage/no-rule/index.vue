  ...
  [
    {
      ...
      load: () => import('@/views/data-manage/no-rule/modules/no-rule/index.vue')
    },
    {
      key: 'item-no-rule',
      labelKey: 'page.dataManage.noRule.itemNoRule.title',
      permission: 'system:dataNoRule:itemNoRule',
      load: () => import('@/views/data-manage/no-rule/modules/item-no-rule/index.vue')
    },
    {
      key: 'no-pool',
      labelKey: 'page.dataManage.noRule.noPool.title',
      permission: 'system:dataNoRule:noPool',
      load: () => import('@/views/data-manage/no-rule/modules/no-pool/index.vue')
    },
    {
      key: 'long-no-rule',
      labelKey: 'page.dataManage.noRule.longNoRule.title',
      permission: 'system:dataNoRule:longNoRule',
      load: () => import('@/views/data-manage/no-rule/modules/long-no-rule/index.vue')
    }
  ],
  { urlSync: true }
);
