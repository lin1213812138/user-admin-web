  ...
  [
    {
      ...
      load: () => import('@/views/data-manage/ship/modules/provider/index.vue')
    },
    {
      key: 'channelGroup',
      labelKey: 'page.dataManage.ship.channelGroup.title',
      permission: 'system:dataShip:channelGroup',
      load: () => import('@/views/data-manage/ship/modules/channel-group/index.vue')
    },
    {
      key: 'weightRule',
      labelKey: 'page.dataManage.ship.weightRule.title',
      permission: 'system:dataShip:weightRule',
      load: () => import('@/views/data-manage/ship/modules/weight-rule/index.vue')
    },
    {
      key: 'carrier',
      labelKey: 'page.dataManage.ship.carrier.title',
      permission: 'system:dataShip:carrier',
      load: () => import('@/views/data-manage/ship/modules/carrier/index.vue')
    }
  ],
  { urlSync: true }
);
