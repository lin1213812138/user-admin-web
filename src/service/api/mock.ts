...
/** 组别/用户 mock 解析 siteName 用的站点引用（站点管理已接真实接口，这里只保留最小引用数据） */
...
/** 站点引用数据（仅供组别/用户 mock 按 siteId 解析站点名展示） */
const sites: SiteFixture[] = [
  { id: 1, siteCode: '75501', siteName: '深圳' },
  { id: 2, siteCode: '75502', siteName: '广州' },
  { id: 3, siteCode: '75503', siteName: '东莞' },
  { id: 4, siteCode: '75504', siteName: '上海' },
  { id: 5, siteCode: '75505', siteName: '北京' },
  { id: 6, siteCode: '75506', siteName: '杭州' }
];
